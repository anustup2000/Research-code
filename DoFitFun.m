function [params,backgroundFit] = DoFitFun( varargin )
...
%   Note please add an _T or _R when making a new function to fit.
    ...
    fitFun1='Doublet_T                   ';
    fitFun2='Singlet_T                   ';
    fitFun3='BistableSing_T              ';
    fitFun4='BistableDoub_T              ';
    
    
    fitFuns=[fitFun1;fitFun2;fitFun3;fitFun4];
